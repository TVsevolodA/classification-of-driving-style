...
#      # },
#      "норм": {
#          "veincle length": 441,  # Длина тс (см)
#          "veincle weight": 1380,  # Вес тс (кг)
#          "axles number": 2,  # Количество осей (2-9)
#          "perceding veincle time-gap": 60,  # время проезда предыдущего тс (1-1800 сек)
#          "Lane of the road": 1,  # Полоса движения на дороге (1 или 2)
#          "veincle speed": 35,  # Скорость (8-160)
#          "perceding veincle speed": 30,  # Скорость предыдущего тс (0-160)
#          "perceding veincle weight": 2021,  # Вес предыдущего тс (3-70000 кг)
#          "perceding veincle length": 500,  # Длина предыдущего тс (100-3000 см)
#          "road condition": 0,  # Состояние дороги: 0-сухая, 1-мокрая, 2-видимые следы, 3-заснеженно
#          "Air temprture": 25,  # Температура воздуха (-13 - +24)
#          "perciption type": 0,  # Облачность: 0-ясно, 1-дождь, 2-снег
#          "perciption intensity": -1,
#          # Скорость выпадения осадков мм/10мин: -1-нет, 0-низкие (0-1), 1-умеренные (1-5), 2-большие (5-16) 3
#          "relatve humadity": 60,  # Относительная влажность воздуха (16-97)
#          "wind direction": 50,  # Направление ветра 0-360 (6-360)
#          "wind speed": 8,  # Скорость ветра (0-17)
#          "Lighting condition": 0  # Условия освещения: 0-день, 1-ночь, 2-сумерки
#      },
#      }
#
