...
import DriverDataEntryForm  from "./driver_data_entry_form";
import "./driver_page.css"
...
export default function DriversInfoPage({ data }: { data: DriversData; }) {
    ...
    const [driverDataModal, setDriverDataModal] = useState<Driver>(null);
    const closeModal = (newTypeForm: string, driver: Driver | null = null) => {
        setDriverDataModal(driver);
        setTypeForm(newTypeForm);
        setIsOpen(!isOpen);
    };

    return (
        <div className="container py-4" id="driverFormModal">
            {isOpen ? <DriverDataEntryForm isOpen={isOpen} onClose={closeModal} userData={owner.id} typeForm={typeForm} driverData={driverDataModal} /> : <></>}
                ...
                <div className="d-flex justify-content-between align-items-center mb-3">
                    ...
                    </div>
                    {
                        owner.role === Role.USER ?
                            <button className="btn btn-primary" onClick={ () => closeModal("add") }>
                        ...
                        </div>
                        {
                            ...
                            <div className="card-footer bg-transparent">
                                ...
                                <button
                                        ...
                                        onClick={ () => closeModal("edit", driver) }
                                >
